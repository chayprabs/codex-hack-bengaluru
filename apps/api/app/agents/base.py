...
class BaseAgent(ABC):
    ...
    def finding(
        ...
        *,
        ...
        line_hints: Sequence[str] | None = None,
        ...
        return AgentFinding(
            ...
            title=title,
            summary=summary,
            technical_summary=technical_summary or summary,
            agent_name=agent_name or self.agent_name,
            check_name=check_name or check_id or rule_id,
            files=list(files or ([file_path] if file_path else [])),
            line_hints=list(line_hints or []),
